...
const platforms = [
  ...
  },
  {
    name: "X / Twitter",
    handle: "@BigDeepBand",
    role: "Press amplification + industry credibility",
    icon: "𝕏",
    color: "bg-neutral-50 border-neutral-300",
    badge: "bg-neutral-100 text-neutral-700",
    rules: [
      "Primary job: reshare press coverage immediately when it drops",
      "Engage with journalists, venues, and jam scene accounts",
      "Text-forward — quick reactions, show announcements, links",
      "Don't create original content just for X — repurpose from elsewhere",
      "Reply to journalists who cover the band — builds press relationships",
      "Hardcore Spafford fans are on here — they'll find you",
    ],
    frequency: "3–4x/week (mostly press reshares)",
    preLaunch: "Claim @BigDeepBand handle. Stay quiet until Apr 9.",
    postLaunch: "Reshare every press drop. Engage journalists. Show announcements.",
  },
  {
    name: "Telegram",
...
const aprilCadenceByPhase = [
  {
    ...
    items: [
      ...
      { platform: "X / Twitter", action: "Reshare L4LM (Apr 9), Wook+ (Apr 13), JamFam (Apr 15)" },
  ...
  },
  {
    ...
    items: [
      ...
      { platform: "X / Twitter", action: "Reshare Relix + JamBase coverage. Tag outlets directly." },
  ...
  },
  {
    ...
    items: [
      ...
      { platform: "X / Twitter", action: "Reshare Relix Daily Dose + JamBase blast. Thank press contacts publicly." },
  ...
  },
  {
    ...
    items: [
      ...
      { platform: "X / Twitter", action: "Eclipse drop Apr 24, single announcements, any new press" },
